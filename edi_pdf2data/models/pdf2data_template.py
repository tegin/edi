...
class Pdf2dataTemplateField(models.Model):
    ...
    _description = "Extract Fields for PDF2Data Templates"
    ...
    field_ids = fields.One2many(
        "pdf2data.template.field", inverse_name="field_id", string="Line Fields"
    )
...
class Pdf2dataTemplateKeyword(models.Model):
    ...
    _description = "Keywords for PDF2Data Templates"
...
class Pdf2dataTemplateReplace(models.Model):
    ...
    _description = "Replace text on PDF2Data Templates"
